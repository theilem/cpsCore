...
Helper::addFactory(PluginRestriction restriction)
{
	...
	{
		CPSLOG_ERROR << "Same id for different factory added. Ignore.";
		return;
	}
...
Helper::addDefault(PluginRestriction restriction)
{
	...
	{
		CPSLOG_ERROR << "Same id for different default factory added. Ignore.";
		return;
	}
...
Helper::addConfigurable()
{
	...
	if (creators_.find(type) != creators_.end())
	{
		CPSLOG_ERROR << "Same id for different configurable added. Ignore.";
		return;
	}
